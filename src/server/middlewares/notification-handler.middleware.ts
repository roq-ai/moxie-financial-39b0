...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'stock_advice.create': {
    roles: ['registered-user'],
    key: 'new-stock-advice',
    tenantPath: ['organization', 'user', 'stock_advice'],
    userPath: [],
  },
  'transaction.update': {
    roles: ['registered-user'],
    key: 'transaction-update',
    tenantPath: ['organization', 'user', 'transaction'],
    userPath: [],
  },
  'simulated_portfolio.create': {
    roles: ['registered-user'],
    key: 'new-simulated-portfolio',
    tenantPath: ['organization', 'user', 'simulated_portfolio'],
    userPath: [],
  },
  'stock.update': { roles: ['registered-user', 'admin'], key: 'stock-update', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['admin'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['visitor-guest', 'registered-user', 'admin'];
