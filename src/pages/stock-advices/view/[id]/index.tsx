...
import { getStockAdviceById } from 'apiSdk/stock-advices';
import { StockAdviceInterface } from 'interfaces/stock-advice';

function StockAdviceViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Stock Advice Details
                  </Text>
                </Box>
                {hasAccess('stock_advice', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/stock-advices/edit/${id}`} passHref legacyBehavior>
                    <Button
