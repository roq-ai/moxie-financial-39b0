...
import { getSimulatedPortfolioById } from 'apiSdk/simulated-portfolios';
import { SimulatedPortfolioInterface } from 'interfaces/simulated-portfolio';

function SimulatedPortfolioViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Simulated Portfolio Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('simulated_portfolio', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/simulated-portfolios/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Virtual Investment" text={data?.virtual_investment} />

                <FormListItem label="Gains Losses" text={data?.gains_losses} />
