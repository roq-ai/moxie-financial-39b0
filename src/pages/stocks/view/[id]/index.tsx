...
import { StockAdviceListPage } from 'pages/stock-advices';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Historical Data" text={data?.historical_data} />

                <FormListItem label="Relevant News" text={data?.relevant_news} />
