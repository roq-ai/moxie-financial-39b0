...
export function StockListPage(props: StockListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStocks({
        relations: [, 'stock_advice.count', 'transaction.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'historical_data.contains', 'relevant_news.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'historical_data', header: 'Historical Data', accessorKey: 'historical_data' },
    { id: 'relevant_news', header: 'Relevant News', accessorKey: 'relevant_news' },
    hasAccess('stock_advice', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'stock_advice',
          header: 'Stock Advice',
          accessorKey: 'stock_advice',
          cell: ({ row: { original: record } }: any) => record?._count?.stock_advice,
        }
      : null,
